...
- Path cost modifier (Shutdown +50%, Control -25% on all structure costs) — not yet implemented; noted in endgame-loop.md Phase 4.
- array_drone_bay structure_repair effect is a data placeholder; engine does not yet process repair events (requires raid system from Phase 7).
