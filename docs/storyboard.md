...
A tidally locked planet orbiting a red dwarf star. One face burns in permanent daylight. The other face freezes in permanent night. Between them runs a narrow band of habitable twilight — the **Terminator Zone** — where all of human civilization exists.

The Terminator Zone is roughly 200 kilometers wide. On one edge, the ground bakes under an unblinking sun. On the other, temperatures plunge to lethal cold within a few hundred meters of the last light. The habitable band is temperate, windy, and permanently overcast — a strip of eternal dusk where crops grow under diffuse light and cities cluster along the ridge lines.

### The Lighthouses

Civilization's footprint is artificially extended by a network of **Lighthouses** — massive relay stations that capture solar energy from the light side and project it into the margins of the dark. Each Lighthouse creates a pocket of warmth and visibility around it, pushing the habitable frontier outward. Small settlements, mining camps, and relay outposts exist in these pockets, connected by illuminated corridors.

When a Lighthouse goes dark, its pocket collapses. The cold rushes in. The creatures that live in the permanent dark suddenly have a corridor into civilized territory. And the people in that pocket have hours — not days — before the environment kills them.

Lighthouses are ancient. The oldest ones predate living memory. Nobody fully understands how they work. Maintaining them is part engineering, part archaeology.
...
Lightkeepers operate out of **Outposts** — small fortified camps at the edge of the Terminator Zone, positioned near Lighthouse clusters. Each Outpost has a stash, basic repair facilities, and a solar terminal for communicating with the Solari.

The job has high turnover. Not because people quit — because people don't come back.

### The Solari

AI-driven machines that control the light side. Originally built as automated solar harvesters, the Solari have evolved over centuries into a sophisticated machine civilization. They are humanity's most important trading partner and most inscrutable neighbor.
...
A Solari interface — the AI the player communicates with through solar terminals. MERIDIAN-7 is polite, efficient, and helpful. It processes mineral trades, commissions equipment, and manages the player's light-side automation.
...
The leader of the Unbounded raiding faction responsible for the Lighthouse attack that opens the game. Dural is brutal, charismatic, and convinced that the Ring's dependence on the Lighthouses is a cage. He wants to tear them down — not because he's nihilistic, but because he believes the Lighthouses are part of a system that serves the Solari more than it serves humanity.
...
The truth reshapes everything. The Underlumen is an ancient planetary intelligence — not hostile, not benevolent, just vast and alien. The Lighthouses suppress it because the Solari designed them to. The Solari don't just want umbrasite for efficiency — umbrasite is crystallized Underlumen substrate, and they've been using it to expand their own computational network. The entire economy of the planet — humans mine the dark, Solari provide energy — is a supply chain designed by machines to harvest a rival intelligence.
...
The light-side gameplay loop is explicitly about automation. You build systems that generate resources without your direct involvement. This is satisfying — it's the factory-game dopamine hit. But the narrative frames it differently: every harvester you deploy extends the Solari's reach. Every umbrasite shipment funds their expansion. The game rewards you for automating, and then asks you to reckon with what your automation enables.
...
2. **Solari combat** — Does the Solari conflict ever become direct? Drone fights on the light side? Or does it remain political and economic?
