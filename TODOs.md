...
## [sonnet] Fix proc_quarantine depth 3 monster density
...
## [sonnet] Difficulty tuning — 0 deaths across all modes
...
## [sonnet] Fix relay_recovery quest — STUCK on junction_a_activated
...
## [sonnet] Fix broken_signal quest — TIMEOUT on daley_coordinates
...
## [sonnet] Improve item and NPC engagement
...
## [opus] Build Lighthouse Mara dungeon
...
## [opus] Build Dural Voss boss encounter
