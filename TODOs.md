...
## 1. Fix relay_recovery quest soft-lock

The `junction_a_activated` flag never gets set in relay_station, causing the relay_recovery side quest to hang indefinitely. Shows up as a soft-lock in `--all-quests` sim runs. Investigate the trigger that should set this flag — likely a missing interaction or condition in relay_station.json.

## 2. Fix phase3_investigation return navigation
...
## 3. Fix explore-mode workshop door gate
...
## 4. Distribute crafting materials across biome loot tables
...
## 5. Wire lighthouse_siege_arena to NPC trigger

The lighthouse_siege_arena dungeon and siege loot tables exist but there's no in-game way to start a siege. The `siege_warden` NPC exists in meridian_station — wire up an NPC interaction that transports the party to the siege arena. This connects a fully-built endgame system to the player experience.

## 6. Connect crypt dungeons to the narrative
...
## 7. Add environmental storytelling to Nightside path
...
## 8. Build Lighthouse Mara dungeon
...
## 9. Add Dural Voss as a named boss encounter
...
## 11. Wire full Array dungeon chain into quest narrative
...
## 13. Weapon upgrade confirmation dialog
...
## 14. Build Spire of Vigil — outer layer (raider stronghold)
...
## 15. Build Spire of Vigil — inner layer (ancient core)
...
## 16. Build Greenway corridor dungeons
...
## 17. Build Spire of Winds (Monument of Winds)
...
## 18. Replace top-priority placeholder sprites
...
## 19. Build Spire of Radiance + Deep Array climax
...
## 20. Deep Expedition (Tier 6) cooperative content
