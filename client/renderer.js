...
class Renderer {
  ...
  _buildIsoTileTextures() {
    ...
    this.tileToIsoKey = {
      ...
      'grass_floor':           'floor2',
      'hedge_wall':            'wall',
      'irrigation_canal':      'water',
      'checkpoint_gate':       'door_closed',
      'supply_crate_closed':   'chest_closed',
      'supply_crate_opened':   'chest_opened',
      'locked_supply_crate':   'chest_closed',
      'crop_row':              'floor',
      'plowed_field':          'floor',
      'wooden_fence':          'wall',
      'barricade':             'wall',
      'trellis_wall':          'wall',
      'depot_gate':            'door_closed',
      'greenhouse_floor':      'floor',
      'greenhouse_wall':       'wall',
      'confiscated_crate':     'chest_closed',
      'hay_bale':              'wall',
      'water_trough':          'wall',
      'elevated_walkway':      'elevated_floor',
      'watchtower_wall':       'full_wall',
      // Biolab tileset
      'lab_floor':             'floor',
      'lab_floor_overgrown':   'floor2',
      'lab_wall':              'wall',
      'lab_door_closed':       'door_closed',
      'lab_door_open':         'door_open',
      'growth_tank':           'wall',
      'locked_lab_door':       'locked_door',
      'containment_wall':      'wall',
      'research_terminal':     'chest_closed',
      'growth_medium':         'floor',
      'broken_glass':          'floor',
      'nutrient_pipe':         'wall',
      'ventilation_grate':     'floor',
      'reinforced_wall':       'wall',
      'vine_barricade':        'wall',
      'planter_bed':           'wall',
      'specimen_locker':       'chest_closed',
      'decontamination_pad':   'floor',
      // Spire Radiance tileset
      'array_floor':           'floor',
      'array_wall':            'wall',
      'coolant_pool':          'water',
      'security_door':         'door_closed',
      'ancient_floor':         'floor',
      'ancient_wall':          'wall',
      'energy_grate':          'floor',
      'hybrid_wall':           'wall',
      'control_panel':         'chest_closed',
      'energy_bridge':         'floor',
      'elevated_platform':     'elevated_floor',
      'solar_conduit':         'floor',
      'radiance_pedestal':     'chest_closed',
      'nexus_blast_door':      'door_closed',
      'solar_gate':            'door_closed',
      'tier_pedestal':         'chest_closed',
      // Spire Winds tileset
      'fortress_wall':         'wall',
      'wind_chasm':            'water',
      'wind_grate':            'floor',
      'metal_wall':            'wall',
      'wind_bridge':           'floor',
      'resonance_pedestal':    'chest_closed',
      'wind_shaft_gate':       'door_closed',
      // Frost crypt extras
      'power_conduit_a':       'chest_closed',
      'power_conduit_b':       'chest_closed',
      'core_hatch':            'door_closed',
      'cracked_ice_wall':      'cracked_wall',
      'geometric_fracture':    'floor',
      'broken_machinery':      'wall',
      'frozen_pillar':         'wall',
      'ice_rubble':            'wall',
      'metal_floor':           'floor',
      'damaged_panel':         'floor',
      'ice_stalagmite':        'wall',
      'collapsed_rubble':      'wall',
      'frozen_pipe':           'wall',
      'seismic_crack':         'floor',
      // Crypt extras
      'junction_box_a':        'chest_closed',
    };
